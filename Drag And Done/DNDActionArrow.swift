...
class DNDActionArrow: UIView {
    ...
    override func drawRect(rect: CGRect) {
        ...
        CGContextMoveToPoint(context, self.bounds.size.width / 4, self.bounds.size.height * 3 / 4)
        CGContextAddLineToPoint(context, self.bounds.size.width / 2, self.bounds.size.height / 2)
        CGContextAddLineToPoint(context, self.bounds.size.width * 3 / 4, self.bounds.size.height * 3 / 4)
